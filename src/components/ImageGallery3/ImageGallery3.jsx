...
const ImageGallery3 = ({ title, description, items }) => {
  return (
          ...
          <div className="container py-2 mx-auto ">
            <div className="flex flex-col md:flex-wrap md:flex-row -m-1 md:-m-2">
              ...
              <div className="flex flex-wrap w-full px-6 lg:px-0 lg:w-1/2 lg:flex-wrap">
                ...
                <div className="w-1/2 p-1 md:p-2">
                  <ImageCard
                    shadowSize={items[4].shadowSize}
                    imageSrc={items[4].img}
                    title={items[4].title}
                  />
                </div>
                <div className="w-full p-1 md:p-2">
                  <ImageCard
                    shadowSize={items[5].shadowSize}
                    imageSrc={items[5].img}
                    title={items[5].title}
                  />
                </div>
              </div>
